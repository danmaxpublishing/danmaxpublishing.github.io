...
NAV = [
    ...
    ("how-to/physical-camera.md", "physical-camera", "Physical Camera", "Guides"),
    ("how-to/relighting.md", "relighting", "Runtime Relighting", "Guides"),
    ("how-to/effects.md", "effects", "Effects & Depth of Field", "Guides"),
    ("how-to/presets.md", "presets", "Presets", "Guides"),
    ("how-to/luts-and-looks.md", "luts-and-looks", "LUT Filters & Looks", "Guides"),
    ...
    ("how-to/webgl-mobile-2d.md", "webgl-mobile-2d", "WebGL, Mobile & 2D", "Guides"),
